# Business Model: Manufacture of bicycles and invalid carriages
...
## Classification
- Repository: `cloud-itonami-isic-3092` ([github.com/cloud-itonami/cloud-itonami-isic-3092](https://github.com/cloud-itonami/cloud-itonami-isic-3092))
- ISIC Rev.5: `3092` — Manufacture of bicycles and invalid carriages
- Domain: `:bicycle-mobility/manufacturing`
- Social impact: :worker-safety :rider-safety :mobility-access-safety
- Actor: `:bicycle-mobility-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :bicycle-mobility/manufacturing — who wants
...
One managed tenant (:bicycle-mobility/manufacturing):
...
- Do not bypass the `:bicycle-mobility-plant-operations-governor` for production decisions.
