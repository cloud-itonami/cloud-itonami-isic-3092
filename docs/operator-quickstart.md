# Operator Quickstart — Manufacture of bicycles and invalid carriages

Shortest path from clone to a verified local dry-run for **ISIC 3092** (`cloud-itonami-isic-3092`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3092.git
cd cloud-itonami-isic-3092
```
...
- Blueprint governor key: `bicycle-mobility-plant-operations-governor`
- Likely source path: `bikemfg.governor.cljc`
