(ns bikemfg.phase
  "Phase 0->3 staged rollout for the bicycle-and-invalid-carriage
  ...
  `bikemfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Bicycle & Mobility Device Plant Operations Governor verdict to
