(ns bikemfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [bikemfg.registry :as r]))
...
(deftest known-product-categories-are-valid
  (doseq [c [:road-bicycle :mountain-bicycle :city-bicycle :cargo-bicycle
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "welder-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "welder-001" 1)
